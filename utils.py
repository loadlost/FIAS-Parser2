# Модуль взаимодействия с API поиска адресов
# Этот модуль предоставляет функции для отправки HTTP-запросов к API поиска адресов, обработки ответов и
# извлечения необходимых данных. Включает в себя методы для отправки POST-запросов с использованием заданных URL,
# данных и заголовков. Также предоставляет функционал по извлечению идентификаторов объектов по их именам из текстовых
